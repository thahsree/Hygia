        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <Section>
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold leading-tight tracking-wide">
                <span className="text-gray-700">Transform Your Living Space</span>
              </h2>
              <p className="text-base md:text-lg lg:text-lg text-gray-600 leading-relaxed max-w-xl tracking-wide">
              ...
              <a href="tel:+919633702776">
                <Button size="default" className="bg-white text-primary text-base lg:text-lg font-semibold hover:bg-gray-100 border-none shadow-xl mt-4">
                  Book This Service
                </Button>
              </a>
            </div>
